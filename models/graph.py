...
class Graph():
    ...
    def get_edge(self, layout):
        ...
        if layout == 'openpose':
            ...
            self.edge = self_link + neighbor_link
            self.center = 2
        elif layout == 'ultrapose':
            self.num_node = 24
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(11, 8), (8, 5), (5, 2), (2, 0), (10, 7), (7, 4),
                              (4, 1), (1, 0), (0, 3), (3, 6), (6, 9),
                              (9, 12), (12, 15), (9, 14), (14, 17), (17, 19),
                              (19, 21), (21, 23), (9, 13), (13, 16), (16, 18),
                              (18, 20), (20, 22)]
            self.edge = self_link + neighbor_link
            self.center = 9
        elif layout == 'ultrapose1':
            self.num_node = 9
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(7, 5), (5, 3), (3, 2), (2, 0), (8, 6), (6, 4),
                              (4, 1), (1, 0)]
            self.edge = self_link + neighbor_link
            self.center = 0
        elif layout == 'ultrapose2':
            self.num_node = 16
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(0, 3), (3, 6), (6, 9),
                              (9, 12), (12, 15), (9, 14), (14, 17), (17, 19),
                              (19, 21), (21, 23), (9, 13), (13, 16), (16, 18),
                              (18, 20), (20, 22)]
            self.edge = self_link + neighbor_link
